'use strict';
ootApp.controller('RegistrationCtrl', ['$scope', '$rootScope', '$location', 'dbService', '$http', 'geolocation', 'registrationService', 'Notification', 'SpinnerDialog',
      function ($scope, $rootScope, $location, dbService, $http, geolocation, registrationService, Notification, SpinnerDialog) {
